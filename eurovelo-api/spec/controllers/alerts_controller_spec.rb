...
RSpec.describe AlertsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new alert" do
        ...
        expect(response.location).to eq(alert_url(Alert.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the alert" do
        alert = Alert.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the alert" do
        alert = Alert.create! valid_attributes
